...
winget install 9N0DX20HK701 Brave.Brave Vencord.Vesktop qBittorrent.qBittorrent Microsoft.VisualStudioCode OBSProject.OBSStudio Ytmdesktop.Ytmdesktop Git.Git Postman.Postman Valve.Steam DBBrowserForSQLite.DBBrowserForSQLite RamenSoftware.Windhawk XP89DCGQ3K6VLD XP89DCGQ3K6VLD 9NT1R1C2HH7J 
